...
7. [Остановка и очистка](#7-остановка-и-очистка)
8. [Решение проблем](#8-решение-проблем)
9. [Архитектура](#9-архитектура)
10. [Публикация своих образов](#10-публикация-своих-образов)
...
### 5.2: Тест вычислений через Backend напрямую
...
### 5.3: Тест вычислений через Frontend (nginx proxy)
...
### 5.4: Тест обработки ошибок (деление на ноль)
...
### 5.7: Тест обработки ошибок в UI
...
### 6.2: Остановка ручных контейнеров
...
### 6.3: Удаление образов (опционально)

```bash
docker rmi calc-backend-image calc-frontend-image
```

### 6.4: Полная очистка Docker
...
### 10.3: Сборка и публикация (скрипт)
...
### 10.5: Публикация на GitHub Container Registry
...
### 10.6: Использование опубликованных образов
